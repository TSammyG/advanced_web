        ...
        <div class="login_box">
            ...
            <div id="second">
                ...
                -->
                    ...
                    <br>
                    <?php
                    if (in_array("This email is already in use<br>", $error_array)) {
                    ...
                    } else if (in_array("Your password can only include uppercase and lowercase letters (a-z, A-Z) and numbers (0-9)<br>", $error_array)) {
                        echo "Your password can only include uppercase and lowercase letters (a-z, A-Z) and numbers (0-9)<br>";
                    ...
                    <?php
                    if (in_array("<span style='color: #14c800;'> Registration complete! You're ready to log in.</span><br>", $error_array)) {
                        echo "<span style='color: #14c800;'> Registration complete! You're ready to log in.</span><br>";
                    }
                    ?>
                    <br>
